...
const Home: NextPage = () => {
  return (
    <Layout home>
      ...
      <div className="sm:text-center lg:text-left sm:mt-12 md:mt-16 lg:mt-20 xl:mt-28 mt-10 mx-auto max-w-7xl">
        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
          <span className="xl:inline dark:text-gray-200">artiro</span>
          <span className="text-blue-600 xl:inline">.io</span>
        </h1>
        <p className="mt-3 text-base text-gray-500 dark:text-gray-400 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
          Bringing your ideas to life through with design, artchitecture, and
          development consulting experiance.
        </p>
